...
import UserCircleImage from '../Components/Image/userCircle';
...
const ProfileLayout =(props, {children}) => {
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <div className='text-center py-3' >
            <UserCircleImage url = {props.user?.image_url} />
        </div>
        <List>
            ...
            {appState.user.role === "Host" && (
              ...
              <ListItem disablePadding>
                <NavLink to="/profile" className={({isActive}) => checkActive(isActive) ? 'drawer_btn active-bar w-100': 'drawer_btn w-100'}>
                  <ListItemButton>
